...
public class FacialFeatures
{
    ...
    public override string ToString() => "Cor do meu olho: " + EyeColor + " tamanho: " + PhiltrumWidth;
...
public class Identity
{
    ...
    public override string ToString() => "Meu email: " + Email + ", Meu facialfeatures: " + FacialFeatures;
